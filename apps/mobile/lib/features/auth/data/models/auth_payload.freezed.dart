...
$AuthPayloadCopyWith<AuthPayload> get copyWith => _$AuthPayloadCopyWithImpl<AuthPayload>(this as AuthPayload, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthPayload&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken)&&(identical(other.expiresIn, expiresIn) || other.expiresIn == expiresIn));
}
...
@override
String toString() {
  return 'AuthPayload(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn)';
}
...
abstract mixin class $AuthPayloadCopyWith<$Res>  {
  factory $AuthPayloadCopyWith(AuthPayload value, $Res Function(AuthPayload) _then) = _$AuthPayloadCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AuthPayloadCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AuthPayload value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AuthPayload value)  $default,){
final _that = this;
switch (_that) {
case _AuthPayload():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AuthPayload value)?  $default,){
final _that = this;
switch (_that) {
case _AuthPayload() when $default != null:
return $default(_that);case _:
...
class _AuthPayload implements AuthPayload {
  const _AuthPayload({@JsonKey(name: 'access_token') required this.accessToken, @JsonKey(name: 'refresh_token') required this.refreshToken, @JsonKey(name: 'expires_in') required this.expiresIn});
  factory _AuthPayload.fromJson(Map<String, dynamic> json) => _$AuthPayloadFromJson(json);
...
@pragma('vm:prefer-inline')
_$AuthPayloadCopyWith<_AuthPayload> get copyWith => __$AuthPayloadCopyWithImpl<_AuthPayload>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AuthPayloadToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthPayload&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken)&&(identical(other.expiresIn, expiresIn) || other.expiresIn == expiresIn));
}
...
/// @nodoc
abstract mixin class _$AuthPayloadCopyWith<$Res> implements $AuthPayloadCopyWith<$Res> {
  factory _$AuthPayloadCopyWith(_AuthPayload value, $Res Function(_AuthPayload) _then) = __$AuthPayloadCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'access_token') String accessToken,@JsonKey(name: 'refresh_token') String refreshToken,@JsonKey(name: 'expires_in') int expiresIn
});
...
/// @nodoc
class __$AuthPayloadCopyWithImpl<$Res>
    implements _$AuthPayloadCopyWith<$Res> {
