    ...
    extend: {
      colors: {
        ...
        surface: {
          ...
          dim: 'var(--color-neutral-95)',
          bright: 'var(--color-neutral-100)',
          container: {
            DEFAULT: 'var(--color-neutral-95)',
            high: 'var(--color-neutral-90)',
            highest: 'var(--color-neutral-80)',
          },
        },
        'on-surface': 'var(--color-neutral-10)',
        outline: {
          DEFAULT: 'var(--color-neutral-variant-50)',
          variant: 'var(--color-neutral-variant-80)',
        },
      },
      fontFamily: {
        primary: ['var(--font-family-primary)', 'sans-serif'],
        header: ['var(--font-family-header)', 'sans-serif'],
        tertiary: ['var(--font-family-tertiary)', 'sans-serif'],
      },
      transitionDuration: {
        short: '150ms',
        medium: '200ms',
