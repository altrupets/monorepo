...
class TonalPaletteGenerator extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPaletteSection(context, 'Primary Palette', CorePalette.of(manager.primaryColor.toARGB32()).primary),
          // ignore: deprecated_member_use
          _buildPaletteSection(context, 'Secondary Palette', CorePalette.of(manager.secondaryColor.toARGB32()).primary),
          // ignore: deprecated_member_use
          ...
          const SizedBox(height: 24),
          // ignore: deprecated_member_use
          _buildPaletteSection(context, 'Neutral Palette', CorePalette.of(manager.primaryColor.toARGB32()).neutral),
          // ignore: deprecated_member_use
          _buildPaletteSection(context, 'Neutral Variant Palette', CorePalette.of(manager.primaryColor.toARGB32()).neutralVariant),
          ...
          children: [
            Row(
              children: [
                ...
                Text('Brand Colors', style: Theme.of(context).textTheme.titleLarge),
                const Spacer(),
                TextButton.icon(
                  onPressed: manager.loadTokens,
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                return Wrap(
                  ...
                  runSpacing: 24,
                  children: [
                    _buildColorPickerItem(context, 'Brand Primary', 'primary', manager.primaryColor, itemWidth),
                    _buildColorPickerItem(context, 'Brand Secondary', 'secondary', manager.secondaryColor, itemWidth),
                    _buildColorPickerItem(context, 'Brand Accent', 'accent', manager.accentColor, itemWidth),
                    _buildColorPickerItem(context, 'Brand Warning', 'warning', manager.warningColor, itemWidth),
                    _buildColorPickerItem(context, 'Brand Error', 'error', manager.errorColor, itemWidth),
                    _buildColorPickerItem(context, 'Brand Success', 'success', manager.successColor, itemWidth),
                  ],
                );
              },
            ),
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () async {
              final newColor = await _showColorPickerDialog(context, label, color);
              if (newColor != null) {
  ...
  Future<Color?> _showColorPickerDialog(BuildContext context, String label, Color currentColor) async {
  ...
  Widget _buildPaletteSection(BuildContext context, String name, TonalPalette palette) {
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const Spacer(),
              _buildTokenBadge(context, name.toLowerCase().replaceAll(' ', '-')),
            ],
          ),
        ),
        LayoutBuilder(
