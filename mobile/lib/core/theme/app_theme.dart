...
/// Configuración de temas de AltruPets
/// Implementa Material 3 con Design System personalizado
class AppTheme {
  AppTheme._();
  ...
  static ThemeData darkTheme() {
    return ThemeData(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        unselectedItemColor: AppColorsDark.onBackground.withOpacity(0.6),
        type: BottomNavigationBarType.fixed,
        elevation: 3,
      ),
