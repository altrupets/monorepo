...
# Script para crear un nuevo proyecto Flutter con AltruPets Skills
...
# Función de ayuda
show_help() {
	echo -e "${BLUE}AltruPets Project Generator${NC}"
	echo ""
	echo "Uso: $0 [OPTIONS]"
	echo ""
	echo "Opciones:"
...
git init -q
git add .
git commit -q -m "Initial commit: Project generated from AltruPets $TEMPLATE template"
